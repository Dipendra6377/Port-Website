...
export const updateReducer = createReducer(initialState, {
  ...
  ADD_GITHUB_REQUEST: (state) => {
    state.loading = true;
  },
  ADD_GITHUB_SUCCESS: (state, action) => {
    state.loading = false;
    state.message = action.payload;
  },
  ADD_GITHUB_FAILURE: (state, action) => {
    state.loading = false;
    state.error = action.payload;
  },

  DELETE_GITHUB_REQUEST: (state) => {
    state.loading = true;
  },
  DELETE_GITHUB_SUCCESS: (state, action) => {
    state.loading = false;
    state.message = action.payload;
  },
  DELETE_GITHUB_FAILURE: (state, action) => {
    state.loading = false;
    state.error = action.payload;
  },
